...
m2m_temp->set_value(temp_value);
m2m_hum->set_value(humidity_value);
...
int main(void)
{
 ...
 m2m_temp = M2MInterfaceFactory::create_resource(m2m_obj_list, 3333, 0, 5704, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
  m2m_hum = M2MInterfaceFactory::create_resource(m2m_obj_list, 3000, 0, 5604, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);  
    ...
    queue.call_every(5000, update_readings);
